...
It started as a beginner project to help me learn Go but I kept going with it because I find it to be quite useful. 
...
- `godoo edit -d -1m:5d -b golden badgers -e -3d:0d -B more common than you might think -D 12d --append`
  ...
  - append append the phrase 'more common than you might think' to the existing body, and change the deadline to 12 days from now
...
- Easier setup/installation
  ...
  - example config/env file in go-doo/env/example-env
- Support deletions 
